...
//分页按钮
    ...
    function initPage(searchData){
        ...
        for(var i=0;i<searchData.length;i++){
            pageContentStr +='<div class="searchpage_contain"><h3><a href="compusCulture.html" class="link">' + searchData[i].schoolName
                        	+'</a></h3><img src="'+ searchData[i].logo +'"><p>'+ searchData[i].address
